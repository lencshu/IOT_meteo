...
</div><!--afficher le temps d'enregistrement de la dernier donn¨¦ sur le page-->
...
</div><!--afficher la temp¨¦rature d'enregistrement de la dernier donn¨¦ sur le page-->
...
</div><!--afficher la direction du vent d'enregistrement de la dernier donn¨¦ sur le page-->
...
</div><!--afficher la vitesse du vent d'enregistrement de la dernier donn¨¦ sur le page-->
<br />
      <div class="compass">
      <div class="direction">
